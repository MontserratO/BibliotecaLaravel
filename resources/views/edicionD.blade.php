        ...
        <header class="masthead" id="masthead2">
            ...
            <div class="container px-4 px-lg-5 d-flex h-10 align-items-center ">
                <div class="col-md-12 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            <form action="/almacenarD" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{$devolucion->id}}">
                                <p> Estado del Libro:</p>
                                <input class="col-md-6" type="text" name="EstadoLibro" id="" value="{{$devolucion->EstadoLibro}}">
                                <br>
                                <input class="btn btn-primary" id = "edit" type="submit" value="Registrar">
                            </form>
                        </div>
                    </div>
                </div>
