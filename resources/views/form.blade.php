                    ...
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            <form action="/agregar" method="post" enctype="multipart/form-data">
                                @csrf
                                <p> Titulo:</p>
                                <input class="col-md-6" type="text" name="Titulo">
                                <p> Portada:</p>
                                <input class="col-md-6 " type="file" name="archivo">
                                <p> Autor:</p>
                                <input class="col-md-6" type="text" name="Autor">
                                <p> Editorial:</p>
                                <input class="col-md-6" type="text" name="Editorial">
                                <p> Categoría:</p>
                                <input class="col-md-6" type="text" name="Categoria">
                                <br>
